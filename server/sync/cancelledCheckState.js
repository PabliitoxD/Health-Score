...
// em server/sync/engine.js), mesmo padrão já usado pra leads (ver
// leadCheckState.js). Reativação de um cliente cancelado é rara o suficiente
// pra não precisar de detecção hora a hora — decisão tomada com o Pablo em
// 2026-07-09, depois de notar que contas já canceladas dominavam o tempo de
// sincronização mesmo sem nunca mudar de estado entre um ciclo e outro.
